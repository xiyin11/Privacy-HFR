...
from model.lightcnn_v4_classifier import LightCNN_V4 as LightCNN_V4_classifier
...
def get_model(cfg,resume=None,protocols=None):
    ...
    model=LightCNN_V4(num_classes=cfg.datasets.num_classes,dropout_rate=cfg.train.dropout_rate)
